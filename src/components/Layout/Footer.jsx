            ...
            <div className="container mx-auto px-6 pt-10 pb-6">
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full md:w-1/4 text-center md:text-left mb-6 md:mb-0">
                        <h5 className="uppercase mb-4 font-bold">HRMS System</h5>
                        <p className="mb-4">
                            Streamlining human resource management for better workplace efficiency and employee satisfaction.
                        </p>
                    </div>
                    ...
                    <div className="w-full md:w-1/4 text-center md:text-left mb-6 md:mb-0">
                        ...
                        <ul className="mb-4">
                            ...
                            <li className="mt-2">
                                <Link to="/employees/search" className="hover:underline">Search</Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    {/* Resources */}
                    <div className="w-full md:w-1/4 text-center md:text-left mb-6 md:mb-0">
                        <h5 className="uppercase mb-4 font-bold">Resources</h5>
                        <ul className="mb-4">
                            <li className="mt-2">
                ...
                <div className="border-t border-gray-700 mt-8 pt-8 md:flex md:items-center md:justify-between">
                    <div className="text-sm text-gray-400 text-center md:text-left">
                        © {currentYear} HRMS System. All rights reserved.
                    </div>
                    <div className="flex mt-4 md:m-0 justify-center md:justify-start">
                        <div className="flex -mx-2">
                            ...
                            <a href="#" className="mx-2 text-gray-400 hover:text-white">Cookies</a>
                        </div>
                    </div>
                </div>
            </div>
